      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 pt-16'>
        <div className='text-center max-w-4xl mx-auto animate-fade-in'>
          <h1 className='text-4xl sm:text-5xl lg:text-5xl font-bold mb-6 leading-tight'>
            ...
            <br />
            Bangladeshi Local Experiences
          </h1>

          <p className='text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed'>
            Connect with passionate local guides who share their culture,
            stories, and hidden gems. Support communities while creating
            ...
            <div className='flex flex-col justify-center items-center sm:flex-row gap-4'>
              <div className='flex-1'>
                <div className='flex mb-4'>
                  <Button
                    variant={
                      searchType === 'destination' ? 'default' : 'outline'
                    }
                    size='sm'
